...
class SudoEntitlementsGetExternalIdTest : BaseTests() {
    ...
    @Test
    fun `getExternalId() should return results when no error present`() =
        runBlocking<Unit> {
            val deferredResult =
    ...
    @Test
    fun `getExternalId() should throw if not signed in`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `getExternalId() should throw when query response is null`() =
        runBlocking<Unit> {
            whenever(
    ...
    @Test
    fun `getExternalId() should throw when response has a NoExternalIdError`() =
        runBlocking<Unit> {
            whenever(
                mockApiCategory.query<String>(argThat { this.query.equals(GetExternalIdQuery.OPERATION_DOCUMENT) }, any(), any()),
            ).thenAnswer {
    ...
    @Test
    fun `getExternalId() should throw when response has a NoBillingGroupError`() =
        runBlocking<Unit> {
            whenever(
                mockApiCategory.query<String>(argThat { this.query.equals(GetExternalIdQuery.OPERATION_DOCUMENT) }, any(), any()),
            ).thenAnswer {
    ...
    @Test
    fun `getExternalId() should throw when response has a EntitlementsSetNotFoundError`() =
        runBlocking<Unit> {
            whenever(
                mockApiCategory.query<String>(argThat { this.query.equals(GetExternalIdQuery.OPERATION_DOCUMENT) }, any(), any()),
            ).thenAnswer {
    ...
    @Test
    fun `getExternalId() should throw when response has a EntitlementsSequenceNotFoundError`() =
        runBlocking<Unit> {
            whenever(
                mockApiCategory.query<String>(argThat { this.query.equals(GetExternalIdQuery.OPERATION_DOCUMENT) }, any(), any()),
            ).thenAnswer {
    ...
    @Test
    fun `getExternalId() should throw when response has error`() =
        runBlocking<Unit> {
            whenever(
                mockApiCategory.query<String>(argThat { this.query.equals(GetExternalIdQuery.OPERATION_DOCUMENT) }, any(), any()),
            ).thenAnswer {
    ...
    @Test
    fun `getExternalId() should throw when http error occurs`() =
        runBlocking<Unit> {
            whenever(
                mockApiCategory.query<String>(argThat { this.query.equals(GetExternalIdQuery.OPERATION_DOCUMENT) }, any(), any()),
            ).thenAnswer {
    ...
    @Test
    fun `getExternalId() should throw when unknown error occurs`() =
        runBlocking<Unit> {
    ...
    @Test
    fun `getExternalId() should find error when unauthorized error occurs`() =
        runBlocking<Unit> {
            whenever(
                mockApiCategory.query<String>(argThat { this.query.equals(GetExternalIdQuery.OPERATION_DOCUMENT) }, any(), any()),
            ).thenAnswer {
    ...
    @Test
    fun `getExternalId() should not suppress CancellationException`() =
        runBlocking<Unit> {
            mockApiCategory.stub {
                on {
                    query<String>(
